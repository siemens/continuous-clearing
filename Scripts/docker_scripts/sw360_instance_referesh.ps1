...
docker ps -a
docker run --name sw360confctnr1 --memory=5g -dt -p ${env:SW360APPPORT}:8080 -p 5985:5984 -p 5435:5432 ${env:DOCKERDEVARTIFACTORY}/energy-dev/software-clearing/sw360/sw360conf:latest
Start-Sleep -s 540

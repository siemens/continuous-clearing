...
namespace LCT.Services
{
    ...
    public class Sw360Service : ISW360Service
    {
        ...
        {
            Logger.Debug($"CheckReleaseExistenceByExternalId():  Get Release Data by using ExternalId : Release name - {componentToBomData.Name}, version - {componentToBomData.Version}");

...
namespace LCT.Common.UTest
{
    ...
    public class LogHandlingTests
    {
        ...
        public void SetUp()
        {
            ...
            LogHandling.Logger = _mockLogger.Object;
        }

        [Test]
        public void HttpErrorHandelingForLog_ShouldLogErrorDetails()
        {
            // Arrange
            ...
            // Act
            LogHandling.HttpErrorHandelingForLog(context, details, ex, additionalDetails);
        ...
        [Test]
        public void HttpErrorHandelingForLog_ShouldLogInnerExceptionDetails()
        {
            // Arrange
            string context = "TestContext";
            string details = "TestDetails";
            ...
            // Act
            LogHandling.HttpErrorHandelingForLog(context, details, exception, additionalDetails);
        ...
        [Test]
        public void BasicErrorHandelingForLog_ShouldLogBasicErrorDetails()
        {
            // Arrange
            string context = "TestContext";
            string details = "TestDetails";
            ...
            // Act
            LogHandling.BasicErrorHandelingForLog(context, details, message, additional);
        ...
        [Test]
        public void HttpResponseErrorHandlingForLog_ShouldLogHttpResponseDetails()
        {
            // Arrange
            string context = "TestContext";
            string details = "TestDetails";
            ...
            // Act
            LogHandling.HttpResponseErrorHandlingForLog(context, details, response, additionalDetails);
        ...
        [Test]
        public void LogRequestDetails_ShouldLogRequestDetails()
        {
            // Arrange
            string context = "TestContext";
            string details = "TestDetails";
            ...
            // Act
            LogHandling.LogRequestDetails(context, details, httpClient, url, httpContent);
        ...
        [Test]
        public void LogHttpResponseDetails_ShouldLogRequestAndResponseDetails()
        {
            // Arrange
            string context = "TestContext";
            string details = "TestDetails";
            ...
            // Act
            LogHandling.LogHttpResponseDetails(context, details, response, additionalDetails);
        ...
        [Test]
        public void LogHttpResponseDetails_ShouldHandleEmptyResponseContent()
        {
            // Arrange
            string context = "TestContext";
            string details = "TestDetails";
        ...
        [Test]
        public void LogHttpResponseDetails_ShouldHandleNullResponse()
        {
            // Arrange
            string context = "TestContext";
            string details = "TestDetails";
            ...
            // Act
            LogHandling.LogHttpResponseDetails(context, details, null, additionalDetails);
        ...
        [Test]
        public void LogHttpResponseDetails_ShouldTruncateContentWhenVerboseIsFalse()
        {
            // Arrange
            string context = "TestContext";
            string details = "TestDetails";
        ...
        [Test]
        public void LogConsolidatedComponentTable_ShouldLogTableWithComponents()
        {
            // Arrange
            ...
            // Act
            LogHandling.LogConsolidatedComponentTable(allComponents, internalComponents);
        ...
        [Test]
        public void LogConsolidatedComponentTable_ShouldLogEmptyTableWhenNoComponents()
        {
            // Arrange
            var allComponents = new List<Component>();
        ...
        [Test]
        public void LogConsolidatedComponentTable_ShouldHandleNullProperties()
        {
            // Arrange
            var allComponents = new List<Component>
            {
        ...
        [Test]
        public void LogComponentsTable_ShouldLogTableWithComponents()
        {
            // Arrange
            ...
            // Act
            LogHandling.LogComponentsTable(filepath, components);
        ...
        [Test]
        public void LogComponentsTable_ShouldLogMessageWhenNoComponents()
        {
            // Arrange
            string filepath = "test-file.json";
        ...
        [Test]
        public void LogComponentsTable_ShouldHandleNullComponents()
        {
            // Arrange
            string filepath = "test-file.json";
        ...
        [Test]
        public void LogComponentsTable_ShouldHandleMissingProperties()
        {
            // Arrange
            string filepath = "test-file.json";
            var components = new List<Component>
        ...
        [Test]
        public void LogCyclonedxComponentsTable_ShouldLogTableWithComponents()
        {
            // Arrange
            string filepath = "test-file.json";
            var components = new List<Component>
            ...
            // Act
            LogHandling.LogCyclonedxComponentsTable(filepath, components);

            // Assert
            _mockLogger.Verify(logger => logger.Debug(It.Is<string>(log =>
                log.Contains("packages FOUND IN FILE: test-file.json") &&
                log.Contains("Component1") &&
                log.Contains("1.0.0") &&
                log.Contains("pkg:example/component1@1.0.0") &&
                log.Contains("Component2") &&
        ...
        [Test]
        public void LogCyclonedxComponentsTable_ShouldLogMessageWhenNoComponents()
        {
            // Arrange
            string filepath = "test-file.json";
            var components = new List<Component>(); // Empty list
            ...
            // Assert
            _mockLogger.Verify(logger => logger.Debug(It.Is<string>(log =>
                log.Contains("No packages were found in the file: test-file.json"))), Times.Once);
        }

        [Test]
        public void LogAvailableComponentList_ShouldLogTableWithComponents()
        {
            // Arrange
            ...
            // Act
            LogHandling.LogAvailableComponentList(components);
        ...
        [Test]
        public void LogAvailableComponentList_ShouldLogMessageWhenNoComponents()
        {
            // Arrange
        ...
        [Test]
        public void LogComparitionComponentListData_ShouldLogTableWithComponents()
        {
            // Arrange
            ...
            // Act
            LogHandling.LogComparitionComponentListData(components);
        ...
        [Test]
        public void LogComparitionComponentListData_ShouldLogMessageWhenNoComponents()
        {
            // Arrange
        ...
        [Test]
        public void LogComparitionComponentListData_ShouldHandleNullComponents()
        {
            // Arrange
        ...
        [Test]
        public void LogCreaterCyclonedxComponentsTable_ShouldLogTableWithComponents()
        {
            // Arrange
            ...
            var components = new List<Component>
        {
            ...
            // Act
            LogHandling.LogCreaterCyclonedxComponentsTable(bomFilePath, components);
        ...
        [Test]
        public void LogCreaterCyclonedxComponentsTable_ShouldLogWarningWhenNoComponents()
        {
            // Arrange
            string bomFilePath = "test-bom.json";
            var components = new List<Component>();
        ...
        [Test]
        public void LogHttpResponseDetailsForStringContent_ShouldLogResponseBody()
        {
            // Arrange
            string context = "TestContext";
            string details = "TestDetails";
            ...
            // Act
            LogHandling.LogHttpResponseDetailsForStringContent(context, details, responseBody, additionalDetails);
        ...
        [Test]
        public void LogHttpResponseDetailsForStringContent_ShouldTruncateResponseBodyWhenVerboseIsFalse()
        {
            // Arrange
            Log4Net.Verbose = false;
            string context = "TestContext";
            ...
            // Act
            LogHandling.LogHttpResponseDetailsForStringContent(context, details, responseBody);
        ...
        [Test]
        public void LogItemDetailsInTableFormat_ShouldLogComparisonTable()
        {
            // Arrange
            ...
            // Act
            LogHandling.LogItemDetailsInTableFormat(methodName, initialItem, updatedItem);

...
namespace LCT.PackageIdentifier.UTest
{
            ...
            var components = new List<Component>
    {
        ...
        //    Bom unsupportedBom = new Bom();

        //    _mockCycloneDxBomParser.Setup(p => p.ParseCycloneDXBom(It.IsAny<string>()))
        //        .Returns(new Bom { Components = new List<Component> { new Component { Name = "CompA", Version = "1.0", Purl = "pkg:cargo/CompA@1.0" } } });

        //    _mockSpdxBomParser.Setup(p => p.ParseSPDXBom(It.IsAny<string>()))
        //        .Returns(new Bom { Components = new List<Component> { new Component { Name = "CompB", Version = "2.0", Purl = "pkg:cargo/CompB@2.0" } } });
        ...
        //[Test]
        //public void ParsePackageFile_HandlesEmptyComponents()
        //{
        //    var appSettings = CreateTestAppSettings();
        //    Bom unsupportedBom = new Bom();

        //    _mockCycloneDxBomParser.Setup(p => p.ParseCycloneDXBom(It.IsAny<string>()))
        //        .Returns(new Bom { Components = new List<Component>() });

        //    var result = _cargoProcessor.ParsePackageFile(appSettings, ref unsupportedBom);

        //    Assert.Null(result);
        //    Assert.IsEmpty(result.Components ?? new List<Component>());
        //}

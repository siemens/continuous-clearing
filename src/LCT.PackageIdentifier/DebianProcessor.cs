...
namespace LCT.PackageIdentifier
{
    ...
    public class DebianProcessor(ICycloneDXBomParser cycloneDXBomParser) : IParser
    {
        ...
        private Component UpdateComponentDetails(Component component, List<AqlResult> aqlResultList, CommonAppSettings appSettings, IBomHelper bomhelper, Property projectType)
        {                        

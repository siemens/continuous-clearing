...
namespace LCT.PackageIdentifier
{
    ...
    public class Program
    {
        ...
        public async Task Run(string[] args)
        {
            ...
            LoggerHelper.SpectreConsoleInitialMessage("Identifier");
            ...
            LoggerHelper.LogInputParameters(caToolInformation, appSettings, listOfInternalRepoList, listOfInclude, listOfExclude, listOfExcludeComponents, "Package Identifier");

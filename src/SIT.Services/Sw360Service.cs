    ...
    public class Sw360Service : ISW360Service
    {
        ...
        public async Task<List<Components>> GetAvailableReleasesInSw360(List<Components> listOfComponentsToBom)
        {
            ...
            try
            {
                ...
                // allDetails=true is a superset of the plain shape; unmapped extra fields are ignored by JsonConvert.
                string responseBody = await m_SW360ApiCommunicationFacade.GetAllReleasesJson();

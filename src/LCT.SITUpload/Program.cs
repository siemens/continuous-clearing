    ...
    public static class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            if (appSettings.Telemetry.Enable)
            {
                ...
                telemetryHelper.StartTelemetry(caToolInformation.CatoolVersion, PackageUploader.uploaderKpiData, TelemetryConstant.SITUploadKpiData);
            }

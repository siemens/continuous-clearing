    ...
    public class SITUploadNpm
    {
        ...
        public void TestSITUploadexe()
        {
            ...
            int result = TestHelper.RunSITUploadExe(new string[]{
                TestConstant.BomFolderPath, Path.GetFullPath(Path.Join(OutFolder, "..", "..", "TestFiles", "IntegrationTestFiles", "SITUploadTestData", "Npm")),
        ...
        {
            OutFolder = TestHelper.OutFolder;
            string comparisonBOMPath = Path.GetFullPath(Path.Join(OutFolder, "..", "..", "TestFiles", "IntegrationTestFiles", "SITUploadTestData", "Npm", "Test_Bom.cdx.json"));

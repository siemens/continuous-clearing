...
namespace SW360IntegrationTest.NPM
{
    ...
    public class SITScanBasicSBOMNpm
    {
        ...
        public void Setup()
        {
            ...
            CCTLocalBomTestFile = Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "src", "SW360IntegrationTest", "SITScanTestFiles", "Npm", "CCTLocalBOMNpmInitial.json"));
        ...
        {
            string packagjsonPath = Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "TestFiles", "IntegrationTestFiles", "SystemTest1stIterationData", "Npm"));

...
namespace SW360IntegrationTest.NPM
{
    ...
    public class SITCreateInitial
    {
        ...
        public void Setup()
        {
            ...
            CCTComparisonBomTestFile = Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "src", "SW360IntegrationTest", "SITCreateTestFiles", "Npm", "CCTComparisonBOMNpmInitial.json"));

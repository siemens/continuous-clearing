...
{
    [TestFixture, Order(8)]
    public class SITCreateWithUpdatedComponents
    {
        ...
        public void Setup()
        {
            ...
            CCTComparisonBomTestFile = Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "src", "SW360IntegrationTest", "SITCreateTestFiles", "Npm", "CCTComparisonBOMNpmUpdated.json"));

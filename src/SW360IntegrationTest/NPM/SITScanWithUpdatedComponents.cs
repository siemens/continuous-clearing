...
{
    [TestFixture, Order(7)]
    public class SITScanWithUpdatedComponents
    {
        ...
        public void Setup()
        {
            ...
            CCTLocalBomTestFile = Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "src", "SW360IntegrationTest", "SITScanTestFiles", "Npm", "CCTLocalBOMNpmUpdated.json"));
        ...
        public void TestBOMCreatorexe()
        {
            ...
            Assert.AreEqual(0, TestHelper.RunSITScanExe(new string[]{
                ...
                TestConstant.Mode,"" }), "Test to run SIT Scan EXE execution");
        }

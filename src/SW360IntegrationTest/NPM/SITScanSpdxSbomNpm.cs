...
namespace SW360IntegrationTest.NPM
{
    ...
    public class SITScanSpdxSbomNpm
    {
        ...
        public void Setup()
        {
            ...
            CCTLocalBomTestFile = Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "src", "SW360IntegrationTest", "SITScanTestFiles", "Npm", "CCTLocalBOMNpmSpdxSbom.json"));

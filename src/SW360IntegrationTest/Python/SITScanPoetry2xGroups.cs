...
namespace SW360IntegrationTest.Python
{
    ...
    public class SITScanPoetry2XGroups
    {
        ...
        public void Setup()
        {
            ...
            CCTLocalBomTestFile = Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "src", "SW360IntegrationTest", "SITScanTestFiles", "Python", "CCTLocalBOMPoetry2xGroups.json"));
        ...
        [Test, Order(1)]
        public void RunSITScanExe_ProvidedPoetry2xLockFile_ReturnsSuccess()
        {

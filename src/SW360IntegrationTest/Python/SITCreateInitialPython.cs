...
namespace SW360IntegrationTest.Python
{
    ...
    public class SITCreateInitialPython
    {
        ...
        public void Setup()
        {
            ...
            CCTComparisonBomTestFile = Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "src", "SW360IntegrationTest", "SITCreateTestFiles", "Python", "CCTComparisonBOMPythonInitial.json"));
        ...
        public void SITCreateExe_ProvidedBOMFilePath_ReturnsSuccess()
        {
            ...
            int returnValue = TestHelper.RunSITCreateExe(new string[] {
                TestConstant.BomFolderPath,bomPath,
                TestConstant.Sw360Token, testParameters.SW360AuthTokenValue,
                TestConstant.SW360URL, testParameters.SW360URL,
                TestConstant.SW360AuthTokenType, testParameters.SW360AuthTokenType,

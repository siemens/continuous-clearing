...
namespace SW360IntegrationTest.Python
{
    ...
    public class PackageIdentifierDepSBOMPython
    {
        ...
        public void Setup()
        {
            ...
            CCTLocalBomTestFile = Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "src", "SW360IntegrationTest", "PackageIdentifierTestFiles", "DepPython", "CCTLocalBOMPythonInitial.json"));

...
{
    [TestFixture, Order(42)]
    public class SITScanSpdxSbomPoetry
    {
        ...
        public void Setup()
        {
            ...
            CCTLocalBomTestFile = Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "src", "SW360IntegrationTest", "SITScanTestFiles", "Python", "CCTLocalBOMPoetrySpdxSbom.json"));
        ...
        {
            string packagejsonPath = Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "TestFiles", "IntegrationTestFiles", "SpdxTestFiles", "Poetry"));

...
namespace SW360IntegrationTest.Python
{
    ...
    public class SITScanDepSBOMPython
    {
        ...
        public void Setup()
        {
            ...
            CCTLocalBomTestFile = Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "src", "SW360IntegrationTest", "SITScanTestFiles", "DepPython", "CCTLocalBOMPythonInitial.json"));
        ...
        {
            string packagejsonPath = Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "TestFiles", "IntegrationTestFiles", "DependencyTestFiles", "Python"));

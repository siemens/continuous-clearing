...
namespace SW360IntegrationTest.Nuget
{
    ...
    public class SITCreateInitialNuget
    {
        ...
        public void Setup()
        {
            ...
            CCTComparisonBomTestFile = Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "src", "SW360IntegrationTest", "SITCreateTestFiles", "Nuget", "CCTComparisonBOMNugetInitial.json"));

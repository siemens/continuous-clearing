...
namespace SW360IntegrationTest.Conan
{
    ...
    public class SITUploadConan
    {
        ...
        {
            OutFolder = Path.GetFullPath(Path.Combine(TestHelper.OutFolder, "..", "..", "TestFiles", "IntegrationTestFiles", "SITUploadTestData", "Conan"));
        ...
        public void ComponentUpload_IsUnsuccessful_AlreadyPresentInDestination_Conan()
        {
            ...
            string comparisonBOMPath = Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "TestFiles", "IntegrationTestFiles", "SITUploadTestData", "Conan", "Test_Bom.cdx.json"));

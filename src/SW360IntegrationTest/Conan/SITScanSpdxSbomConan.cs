...
namespace SW360IntegrationTest.Conan
{
    ...
    public class SITScanSpdxSbomConan
    {
        ...
        public void Setup()
        {
            ...
            CCTLocalBomTestFile = Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "src", "SW360IntegrationTest", "SITScanTestFiles", "Conan", "CCTLocalBOMConanSpdxSbom.json"));

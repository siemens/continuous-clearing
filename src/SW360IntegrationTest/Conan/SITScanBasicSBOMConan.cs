...
namespace SW360IntegrationTest.Conan
{
    ...
    public class SITScanBasicSBOMConan
    {
        ...
        public void Setup()
        {
            ...
            CCTLocalBomTestFile = Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "src", "SW360IntegrationTest", "SITScanTestFiles", "Conan", "CCTLocalBOMConanInitial.json"));

...
namespace SW360IntegrationTest.Debian
{
    ...
    internal class SITScanSpdxSbomDebian
    {
        ...
        public void Setup()
        {
            ...
            CCTLocalBomTestFile = Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "src", "SW360IntegrationTest", "SITScanTestFiles", "Debian", "CCTLocalBOMDebianSpdxSbom.json"));

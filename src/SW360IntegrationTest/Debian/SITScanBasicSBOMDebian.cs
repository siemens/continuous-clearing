...
namespace SW360IntegrationTest.Debian
{
    ...
    public class SITScanBasicSBOMDebian
    {
        ...
        public void Setup()
        {
            ...
            CCTLocalBomTestFile = Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "src", "SW360IntegrationTest", "SITScanTestFiles", "Debian", "CCTLocalBOMDebianInitial.json"));

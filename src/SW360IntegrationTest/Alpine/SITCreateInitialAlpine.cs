...
namespace SW360IntegrationTest.Alpine
{
    ...
    class SITCreateInitialAlpine
    {
        ...
        public void Setup()
        {
            ...
            CCTComparisonBomTestFile = Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "src", "SW360IntegrationTest", "SITCreateTestFiles", "Alpine", "CCTComparisonBOMAlpineInitial.json"));

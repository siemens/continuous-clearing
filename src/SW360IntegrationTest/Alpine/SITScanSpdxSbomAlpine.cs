...
namespace SW360IntegrationTest.Alpine
{
    ...
    public class SITScanSpdxSbomAlpine
    {
        ...
        public void Setup()
        {
            ...
            CCTLocalBomTestFile = Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "src", "SW360IntegrationTest", "SITScanTestFiles", "Alpine", "CCTLocalBOMAlpineSpdxSbom.json"));
        ...
        {
            string packagejsonPath = Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "TestFiles", "IntegrationTestFiles", "SpdxTestFiles", "Alpine"));

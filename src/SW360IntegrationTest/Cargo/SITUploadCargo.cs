...
namespace SW360IntegrationTest.Cargo
{
    ...
    public class SITUploadCargo
    {
        ...
        public void TestSITUploadexe()
        {
            ...
            int result = TestHelper.RunSITUploadExe(new string[]{
                TestConstant.BomFolderPath, Path.GetFullPath(Path.Join(OutFolder, "..", "..", "TestFiles", "IntegrationTestFiles", "SITUploadTestData", "Cargo")),
        ...
        {
            OutFolder = TestHelper.OutFolder;
            string comparisonBOMPath = Path.GetFullPath(Path.Join(OutFolder, "..", "..", "TestFiles", "IntegrationTestFiles", "SITUploadTestData", "Cargo", "Test_Bom.cdx.json"));

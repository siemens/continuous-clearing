...
namespace SW360IntegrationTest.Cargo
{
    ...
    public class SITCreateInitialCargo
    {
        ...
        public void Setup()
        {
            ...
            CCTComparisonBomTestFile = Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "src", "SW360IntegrationTest", "SITCreateTestFiles", "Cargo", "CCTComparisonBOMCargoInitial.json"));
        ...
        [Test, Order(1)]
        public void TestSITCreateExe_Cargo()
        {
            string bomPath = Path.GetFullPath(Path.Combine(OutFolder, "..", "BOMs"));
            // Assert
            // Check exit is normal
            Assert.AreEqual(0, TestHelper.RunSITCreateExe(new string[] {
                TestConstant.BomFolderPath,bomPath,
                TestConstant.Sw360Token, testParameters.SW360AuthTokenValue,
                TestConstant.SW360URL, testParameters.SW360URL,
                TestConstant.SW360AuthTokenType, testParameters.SW360AuthTokenType,

...
namespace SW360IntegrationTest.Cargo
{
    ...
    public class SITScanBasicSBOMCargo
    {
        ...
        public void Setup()
        {
            ...
            CCTLocalBomTestFile = Path.GetFullPath(Path.Join(OutFolder, "..", "..", "src", "SW360IntegrationTest", "SITScanTestFiles", "Cargo", "CCTLocalBOMCargoInitial.json"));
            ...
            testParameters = new TestParamCargo();
        }

        [Test, Order(1)]
        public void RunSITScanExe_ProvidedPackageJsonFilePath_ReturnsSuccess()
        {
            string packagejsonPath = Path.GetFullPath(Path.Join(OutFolder, "..", "..", "TestFiles", "IntegrationTestFiles", "SystemTest1stIterationData", "Cargo"));

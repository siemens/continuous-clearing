...
namespace SW360IntegrationTest.Choco
{
    ...
    public class SITScanInitialChoco
    {
        ...
        public void Setup()
        {
            ...
            CCTLocalBomTestFile = Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "src", "SW360IntegrationTest", "SITScanTestFiles", "Choco", "CCTComparisonBOMChocoInitial.json"));

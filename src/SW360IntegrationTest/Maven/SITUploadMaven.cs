    ...
    public class SITUploadMaven
    {
        ...
        public void TestSITUploadexe()
        {
            ...
            int result = TestHelper.RunSITUploadExe(new string[]{
                TestConstant.BomFolderPath, Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "TestFiles", "MavenTestFile", "SITUploadTestData")),
        ...
        {
            OutFolder = TestHelper.OutFolder;
            string comparisonBOMPath = Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "TestFiles", "MavenTestFile", "SITUploadTestData", "Test_Bom.cdx.json"));

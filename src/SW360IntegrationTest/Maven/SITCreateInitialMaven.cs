...
namespace SW360IntegrationTest.Maven
{
    ...
    public class SITCreateInitialMaven
    {
        ...
        public void Setup()
        {
            ...
            CCTComparisonBomTestFile = Path.GetFullPath(Path.Combine(OutFolder, "..", "..", "src", "SW360IntegrationTest", "SITCreateTestFiles", "Maven", "CCTComparisonBOMMavenUpdated.json"));

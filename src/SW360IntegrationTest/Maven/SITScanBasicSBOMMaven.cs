...
namespace SW360IntegrationTest.Maven
{
    ...
    public class SITScanBasicSBOMMaven
    {
        ...
        public void Setup()
        {
            ...
            CCTLocalBomTestFile = Path.GetFullPath(Path.Join(OutFolder, "..", "..", "src", "SW360IntegrationTest", "SITScanTestFiles", "Maven", "CCTLocalBOMMavenInitial.json"));

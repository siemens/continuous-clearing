...
namespace SW360IntegrationTest.Maven
{
    ...
    public class SITScanSpdxSbomMaven
    {
        ...
        public void Setup()
        {
            ...
            CCTLocalBomTestFile = Path.GetFullPath(Path.Join(OutFolder, "..", "..", "src", "SW360IntegrationTest", "SITScanTestFiles", "Maven", "CCTLocalBOMMavenSpdxSbom.json"));

...
namespace LCT.Services.UTest
{
    ...
    public class Sw360ProjectServiceTest
    {
        ...
        [Test]
        public async Task GetProjectNameByProjectIDFromSW360_InvalidSW360Credentials_HttpRequestException_ReturnsProjectResponseAsNull()
        {
            // Arrange
            ...
            // Assert
            Assert.IsNull(actualProjectName, "GetProjectNameByProjectIDFromSW360 does not return empty on exception");
        }

        [Test]
        public async Task GetProjectNameByProjectIDFromSW360_InvalidSW360Credentials_AggregateException_ReturnsProjectResponseAsNull()
        {
            // Arrange
            Mock<ISW360ApicommunicationFacade> sw360ApicommunicationFacadeMck = new Mock<ISW360ApicommunicationFacade>();
        ...
        [Test]
        public async Task GetProjectNameByProjectIDFromSW360_ValidProjectIdAndName_ReturnsProjectNameAsNull()
        {
            // Arrange
            ...
            // Assert
            Assert.IsNull(actualProjectName, "Project Id not exist");
        }
        ...
        public async Task GetProjectNameByProjectIDFromSW360_ValidProjectNameAndId_ReturnsTheProjectName()
        {
            ...
            // Assert
            Assert.That(actualProjectName.Name, Is.EqualTo(expectedName), "Project Id not exist");
        }

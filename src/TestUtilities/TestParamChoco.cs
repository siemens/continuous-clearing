...
namespace TestUtilities
{
 ...
 new ConfigurationBuilder().AddJsonFile(@"appSettingsSW360IntegrationTest.json", true, true).Build();
        ...
        public TestParamChoco()
        {
            ...
            ThirdPartyDestinationRepoName = "choco-test";
            InternalDestinationRepoName = "choco-test";
            DevDestinationRepoName = "choco-test";

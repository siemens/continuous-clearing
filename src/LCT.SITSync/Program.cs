...
namespace LCT.SITSync
{
    ...
    public class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            LoggerHelper.SpectreConsoleInitialMessage("SIT Sync");

            if (appSettings.IsTestMode)
                Logger.Logger.Log(null, Level.Alert, $"SIT Sync is running in TEST mode \n", null);
            ...
            if (appSettings.Telemetry.Enable)
            {
                ...
                telemetryHelper.StartTelemetry(caToolInformation.CatoolVersion, ComponentCreator.KpiData, TelemetryConstant.SITSyncKpiData);
            }
            Logger.Logger.Log(null, Level.Notice, $"End of SIT Sync execution: {DateTime.Now}\n", null);

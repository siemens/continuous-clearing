    ...
    public class Repository : IRepository
    {
        ...
        string IRepository.IdentifyRepoURLForGit(string url, string componentName)
        {
            ...
            catch (ArgumentOutOfRangeException ex)
            {
                ...
                LogHandling.HttpErrorHandelingForLog("IdentifyRepoURLForGit", $"MethodName:IdentifyRepoURLForGit(), ComponentName: {componentName}, URL: {url}", ex, "An error occurred while identifying the repository URL. The URL format might be invalid.");

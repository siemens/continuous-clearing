...
namespace LCT.Facade.UTest
{
    ...
    public class SW360ApicommunicationFacadeTest
    {
        ...
        public async Task GetReleaseById_OnSuccess_ReturnsReleaseInfoInAString()
        {
            ...
            //Act          
            sW360ApicommunicationFacade = new SW360ApicommunicationFacade(mockSw360comm.Object, false);
            HttpResponseMessage actual = await sW360ApicommunicationFacade.GetReleaseById("8454858hjfjkdshldsfhiruewi", "8454858hjfjkdshldsfhiruewi");
        ...
        [TestCase(true)]
        [TestCase(false)]
        public async Task CreateComponent_OnNonTestMode_ForGivenReleaseIdArray_ReturnsHttpResponse(bool testmode)
        {
            //Arrange 
        ...
        [TestCase(true)]
        [TestCase(false)]
        public async Task UpdateRelease_OnNonTestMode_ForGivenReleaseId_ReturnsHttpResponse(bool testMode)
        {
            //Arrange 

...
namespace LCT.SITSync.UTest
{
            ...
            IDictionary<string, IPackageDownloader> _packageDownloderList = new Dictionary<string, IPackageDownloader>
    {
        ...
        public void Test_GetAttachmentUrlListForMvn()
        {
            ...
            string localPathforDownload = Path.GetFullPath(Path.Combine(outFolder, "..", "..", "src", "LCT.SITSync.UTest", "SITSyncUTFiles")) + Path.DirectorySeparatorChar;

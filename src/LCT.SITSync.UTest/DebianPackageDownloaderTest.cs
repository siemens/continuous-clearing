...
namespace LCT.SITSync.UTest
{
    ...
    class DebianPackageDownloaderTest
    {
        ...
        //string attachmentJson = outFolder + @"..\..\..\src\LCT.SITSync.UTest\SITSyncUTFiles\Attachment.json";
        // 
        ...
        public void GetPatchedFileFromDownloadedFolder_ProvidedPatchURLs_ReturnsEmptyDownloadPath()
        {
            ...
            string downloadFolderPath = outFolder + @"..\..\..\src\LCT.SITSync.UTest\SITSyncUTFiles";
